...
<title>Distribution Agency:: Add Bank</title>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">                                    
                                    <div class="input-group masked-input">
                                        ...
                                        <input type="text" class="form-control date" placeholder="Bank Name">
                                    </div>
                                </div>
                                <div class="form-group">                                   
                                    <div class="input-group masked-input">
                                        ...
                                        <input type="text" class="form-control date" placeholder="Account Number">
                                    </div>
                                </div>
                                <div class="form-group">                                   
                                    <div class="input-group masked-input">
