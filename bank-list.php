...
<title>Distribution Agency:: Bank List</title>
                            ...
                            <table class="table table-hover c_table theme-color">
                                <thead>
                                    <tr>                                       
                                        ...
                                        <th class="hidden-md-down" width="150px">Account Number</th>
                                        <th>Bank Name</th>
                                        <th>Amount</th>
                                        <th>Action</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a class="single-user-name" href="javascript:void(0);">Muhammad Ali</a><br>
                                        </td>

                                        <td>
                                            <strong>08333983983</strong><br>
                                        </td>
