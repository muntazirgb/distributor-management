...
<title>Distribution Agency:: Add Product</title>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">                                    
                                    <div class="input-group masked-input">
                                        ...
                                        <input type="text" class="form-control date" placeholder="Product Name">
                                    </div>
                                </div>
                                <div class="form-group">                                   
                                    <div class="input-group masked-input">
                                        ...
                                        <input type="text" class="form-control date" placeholder="Product Details">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">                                   
                                    <div class="input-group masked-input">
                                        ...
                                        <input type="text" class="form-control date" placeholder="Product SKU">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">                                   
                                    <div class="input-group masked-input">
                                        ...
                                        <input type="text" class="form-control date" placeholder="Product Price">
                                    </div>
                                </div>
